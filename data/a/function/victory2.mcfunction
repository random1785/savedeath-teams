...
#execute as @a[scores={death=18,team=3},tag=a,tag=!b] run gamemode spectator @a[scores={team=1}]
#execute as @a[scores={death=18,team=4},tag=a,tag=!b] run gamemode spectator @a[scores={team=1}]
#execute as @a[scores={death=18,team=5},tag=a,tag=!b] run gamemode spectator @a[scores={team=1}]
#execute as @a[scores={death=18,team=6},tag=a,tag=!b] run gamemode spectator @a[scores={team=1}]
#execute as @a[scores={death=18,team=7},tag=a,tag=!b] run gamemode spectator @a[scores={team=1}]
