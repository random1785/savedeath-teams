...
execute as @e[type=armor_stand,tag=score,scores={score=0..69420}] run execute unless entity @a[scores={death=17,health=1..500}] run schedule function a:zzzhealthcalc1 2s