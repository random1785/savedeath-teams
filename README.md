...
Publicly shames players for leaving the cage using a title command<br/>
Escapers have a powerup to break blocks around them in case they get trapped
...
The person dying recieves a helmet to change creeper's max damage to about 7? ish hearts.
